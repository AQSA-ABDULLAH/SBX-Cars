...
const cars = [
  {
    imageUrl: "https://i.sbxcars.com/cdn-cgi/image/width=900,height=1352,quality=80,format=webp,fit=cover/auctions/e293e549-fd95-4122-9fcf-741b8faec9ec/DSC_3447.jpg",
    carName: "Lotus Exige",
    carYear: "2022",
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 row-gap-4 px-4 sm:px-8">
        {cars.map((car, index) => (
          <Card
            ...
            auctions={Object.values(car.Auctions)} 
          />
        ))}
      </section>
    </div>
